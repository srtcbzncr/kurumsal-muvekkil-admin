...
import { Box, Stack, Button, Typography, Avatar, InputBase, IconButton, Link } from '@mui/material';
    ...
    <Layout>
      <Stack direction="column" sx={{ width: 1, alignItems: "center" }}>
        ...
        <Stack direction="column" sx={{ width: 0.8, backgroundColor: "secondary.main", marginTop: "50px" }}>
          ...
          <Box display="flex" sx={{ width: 1, border: 1, borderColor: "border.secondary", justifyContent: "center", padding: "10px", 
